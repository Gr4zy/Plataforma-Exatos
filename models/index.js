...
Quiz.belongsTo(Lesson, { as: 'lesson', foreignKey: { name: 'lessonId', allowNull: true } });
...
Question.hasMany(QuestionImage, { as: 'images', foreignKey: 'questionId', onDelete: 'CASCADE' });
QuestionImage.belongsTo(Question, { as: 'question', foreignKey: 'questionId' });
